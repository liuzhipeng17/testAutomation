...
public class Junit5Demo {
    ...
    private int appId = 700011;
    private String messageId = "7019";
    private String appKey = "f6d4070c0b5da540e0976796c79d527f";
    ...
    public void signTest() throws UnsupportedEncodingException {
        ...
        json.put("appId", 11);
        json.put("roleId", "9258385");
        json.put("serverId", "226");
        json.put("version", "1");
        json.put("extra", "");
        JSONObject bodyJson = new JSONObject(true);
        bodyJson.putAll(json);
        //System.out.println(getSignature(bodyJson));
    }

    @Test
    public void getActivityLabelV3Test() throws UnsupportedEncodingException{
